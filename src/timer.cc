...
Timer::Timer (const unsigned int start_time, const unsigned int end_time) : start_time_(start_time), end_time_(end_time) {
...
std::string Timer::SecondsToTime (const unsigned int seconds) const {
	std::string answer;

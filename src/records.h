...
private:
	...
	std::map<Queues, std::pair<unsigned int, long double>> queue_records_;
	// first of pair is last check time, second of pair is average queue length
};

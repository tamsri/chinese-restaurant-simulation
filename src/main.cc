...
int main ( ) {
	...
	const Variables variables = {
			...
			150,									// average arrival interval of customer group
			10*10,								// variance arrival interval of customer group
	...
	const unsigned int seed = 5;										// selected set of initial kernel set in kernel of generators
